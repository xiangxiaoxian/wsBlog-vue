...
<span class="el-dropdown-link" id="dropdown-link1">
  ...
  <el-dropdown-menu slot="dropdown" class="dropdown-menu1">
    <el-dropdown-item class="el-icon-s-custom">我的资料</el-dropdown-item>
    <el-dropdown-item class="el-icon-s-tools">后台管理</el-dropdown-item>
...
<!--       
      ...
      <!-- <el-dropdown v-if="this.$store.state.token !==''">
       <span class="el-dropdown-link">
          <el-avatar class="actor" :size="large" :src="circleUrl" ></el-avatar>
       </span>
