<template>
  <div>
    ...
    <el-card>
      ...
      <el-row :gutter="20">
        <el-col :span="8">
          <el-input placeholder="请输入昵称查找" v-model="searchField" clearable @clear="getUserList">
      ...
      <div>
        ...
        <p>分配新角色：
          <el-select v-model="selectedRoleId" placeholder="请选择">
            <el-option v-for="item in rolesList" :key="item.id" :label="item.roleName" :value="item.id" v-if="item.roleName!=='超级管理员'">
            </el-option>
          </el-select>
        </p>
      </div>
